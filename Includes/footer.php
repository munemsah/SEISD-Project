...
<div class="container text-center text-md-left">
  ...
  <div class="row">
    ...
    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
      ...
      <p>
        <a class="text-warning" href="#!">Blood Relation</a>
      </p>
      <p>
        <a class="text-warning" href="#!">Keep Safe Blood</a>
      </p>
      <p>
        <a class="text-warning" href="#!">Preserve Blood</a>
      </p>
      <p>
        <a class="text-warning" href="#!">Donation Center</a>
      </p>
      <p>
        <a class="text-warning" href="#!">Proper Education</a>
      </p>
    ...
    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
      ...
      <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
      <p>
        <a class="text-warning" href="Blog.php">Blog</a>
      </p>
      <p>
        <a class="text-warning" href="#!">Upcoming Events</a>
      </p>
      <p>
        <a class="text-warning" href="#!">Latest News</a>
      </p>
      <p>
      ...
      <p>
        <a class="text-warning" href="#!">Terms and Condition</a>
      </p>
    ...
    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
      ...
      <p class="text-warning">
        <i class="fa fa-home mr-3 text-white"></i> North Agrabad, Chittagong</p>
      <p class="text-warning">
        <i class="fa fa-envelope mr-3 text-white"></i> news@blueblood.com</p>
      <p class="text-warning">
        <i class="fa fa-phone mr-3 text-white"></i> + 01711 1111 11</p>
      <p class="text-warning">
        <i class="fa fa-print mr-3 text-white"></i> + 01811 1111 11</p>
...
<ul class="list-unstyled list-inline text-center">
  ...
  <li class="list-inline-item">
    <a class="btn-floating btn-gplus mx-1">
      <i class="fa fa-pinterest fa-2x text-danger"> </i>
    </a>
  </li>
  <li class="list-inline-item">
...
<!-- Copyright -->
<div class="footer-copyright text-center py-3 text-white">Copyright 2019 - BlueBlood by BlueWindLab. All Rights Reserved.
