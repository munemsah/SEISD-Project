...
<section class="my-5">
	<div class="py-5">
		<h2 class="text-center text-black"> DONATION PROCESS</h2>
		<h4 class="text-center text-black"> The donation process from the time you arrive center until the time you leave</h4>
	</div>
...
<section class="my-5">
	<div class="py-5">
		<h2 class="text-center text-danger"> CAMPAIGN GALLERY</h2>
		<h4 class="text-center text-dark"> Our Prestigious voluntary work on campaigns by the team </h4>
	</div>
...
<br>
	...
	<div> <a href="Donate money\payment.php" class="btn btn-danger btn-lg text-center">
...
<div class="text-center">
 ...
 <br>
  ...
  <h1 >The volunteers who give their time and<br>
  talents help to fulfill our mission.</h1>
 <br>
 <br>
  <p class="lead">
    <a class="btn btn-danger btn-lg" href="volunteerlogin.php" role="button">BECOME A VOLUNTEER</a>
  </p>
</div>
<br>
<br>
